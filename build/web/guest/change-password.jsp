<%-- 
    ...
    Created on : Jun 29, 2021, 6:42:52 PM
    Author     : hp
--%>
...
<body>
    ...
    <!--Main-->
    <div class="account changepw" style="margin-top: 56px;">
        <div class="container account-cont">
            <div class="row none-mp">
                <div class="col-3 none-mp">
                    <div class="account-menu box">
                        ...
                        <ul class="account-list">
                            <a href="info">
                                <li class="account-list-item">Thông tin tài khoản</li>
                            </a>
                            <a href="follow">
                                <li class="account-list-item">Truyện đang theo dõi</li>
                            </a>
                            <a href="change-password">
                                <li class="account-list-item active">Đổi mật khẩu</li>
                            </a>
                            <a href="logout">
                ...
                <div class="col-9 account-infor none-mp">
                    <div class="row changepw-box">
                        <div class="col infor-form changepw-form">
                            <form action="change-password" method="POST">
                                <p class="changepw-title title">Đổi mật khẩu</p>
                                
                                <span style="color:red"><c:out value="${err}"></c:out></span>
                                <div class="form-group">
                                    <label class="title-form" for="password">Mật khẩu hiện tại</label>
                                    <div class="input-icons">
                                        <input id="password" class="form-control form__input" type="password" name="password"
                                            placeholder="Nhập mật khẩu" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="title-form" for="password">Mật khẩu mới</label>
                                    <div class="input-icons">
                                        <input id="password" class="form-control form__input" type="password" name="newPassword"
                                            placeholder="Nhập mật khẩu mới" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="title-form" for="password">Xác nhận mật khẩu</label>
                                    <div class="input-icons">
                                        <input id="password" class="form-control form__input" type="password" name="confirmPassword"
                                            placeholder="Nhập mật khẩu xác nhận" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <button type="submit" class="btn btn-submit">Thay đổi</button>
                                </div>
