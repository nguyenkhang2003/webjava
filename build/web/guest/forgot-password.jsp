            ...
            <div class="col-6 login-box">
                <div class="row">
                    <div class="col sub-signup">
                        ...
                        <p style="padding: 0rem 0.5rem;">Vui lòng nhập email để tìm kiếm tài khoản của bạn. Chúng tôi sẽ gửi mật khẩu vào email của bạn!</p>
                        <hr class="none-mp">
                    </div>
                </div>
                <div class="row login-form">
                    <form method="POST" class="col" id="signupForm" action="forgot-password">
                        <span style="color:red">${err}</span>
                        
                        <div class="form-group input_group al-login">
                            <input id="email" class="form-control" name="email" type="text" autocomplete="on"
                                placeholder="Vui lòng nhập email để tìm lại mật khẩu ">
                        </div>
                    
                        <div class="form-group">
                            <input type="submit" id="submit" value="Tìm kiếm" class="btn btn-primary login-btn align-input" name="submit">
                        </div>
