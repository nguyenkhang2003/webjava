<%-- 
    Document   : login
    Created on : Jun 27, 2021, 6:12:02 PM
    Author     : hp
--%>
        ...
        <div class="row login-mg-pd">
            ...
            <div class="col-6 login-box">
                <div class="row login-form">
                    <div class="col">
                        <form method="POST" class="" id="signupForm" action="login">
                            
                            <span style="color:red">${err}</span>
                            <div class="form-group input_group al-login">
                                <input id="email" class="form-control align-input" name="username" type="text" autocomplete="on"
                                    placeholder="Tên tài khoản">
                            </div>
                
                
                            <div class="form-group input_group al-login">
                                <input id="password" class="form-control  align-input" name="password" type="password"
                                    placeholder="Mật khẩu">
                            </div>
                
                
                            <div class="form-group">
                                <input type="submit" id="submit" value="Đăng nhập" class="align-input btn btn-primary login-btn"
                                    name="submit">
                            </div>
