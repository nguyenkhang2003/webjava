...
<body class="login">
    ...
    <div class="container">
        <div class="row signup-mg-pd">
            <div class="col-6 brand-signup">
                <img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/index/logo-phattruyen-01.png" alt="">
                <p>Đọc truyện online chất lượng cao. <br>
                    Mang đến cho bạn những trải nghiệm tuyệt vời nhất.</p>
            </div>
            <div class="col-6 login-box">
                <div class="row">
                    <div class="col sub-signup">
                        <h2>Đăng ký</h2>
                ...
                <div class="row login-form">
                    <form method="POST" class="col" id="signupForm" action="signup">

                        <div class="row none-mp name-form">
                            <div class="col-6 surname-input none-mp">
                                <input id="surname" class="form-control" name="surname" type="text" autocomplete="on" placeholder="Họ">
                            </div>
                            <div class="col-6 lastname-input none-mp">
                                <input id="lastname" class="form-control" name="lastname" type="text" autocomplete="on" placeholder="Tên">
                            </div>
                        </div>
                        
                        <div class="form-group input_group al-login">
                            <input id="username" class="form-control" name="username" type="text" autocomplete="on"
                                placeholder="Tên tài khoản">
                        </div>
                        
                        <div class="form-group input_group al-login">
                            <input id="password" class="form-control  align-input" name="password" type="password" placeholder="Mật khẩu">
                        </div>
                        ...
                        <div class="form-group input_group al-login">
                            <input id="sdt" class="form-control  align-input" name="phone" type="text" autocomplete="on"
                                placeholder="Số điện thoại">
                        </div>

                        <div class="form-group">
                            <input type="submit" id="submit" value="Đăng ký" class="btn btn-primary signup-btn align-input" name="submit">
                        </div>
                        
                    </form>
                </div>
                <div class="row">
                    <div class="col fg-pswd">
