...
<body>
    ...
    <!--Main-->
	<div class="admin-dashboard" style="margin-top: 50px;">
		<div class="row none-mp">
			...
			<div class="col none-mp box-db">
				...
				<div class="row none-mp">
					<!--user-->
					<div class="col none-mp card-users db-1">
						<div class="row none-mp">
							<div class="col-8 view-users">
								<p class="title-db">Người quản trị hệ thống</p>
								<hr>
								<p><span>Họ và tên: </span>Nguyễn Đỗ Tường Phát</p>
								<p><span>Điện thoại: </span>0375577127</p>
								<p><span>Email: </span>phat123@gmail.com</p>
							</div>
							<div class="col-4 avt-users">
								<img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/user/avt-Phat.png" alt="">
							</div>
						</div>
					</div>
					<!--End-->
					<div class="col none-mp card-users db-1">
						<div class="row none-mp">
							<div class="col-8 view-users">
								<p class="title-db">Quản trị viên</p>
								<hr>
								<p><span>Họ và tên: </span>Huỳnh Thanh Liêm</p>
								<p><span>Điện thoại: </span>0375577127</p>
								<p><span>Email: </span>liem123@gmail.com</p>
							</div>
							<div class="col-4 avt-users">
								<img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/user/avt-Lim.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col none-mp card-users db-1">
						<div class="row none-mp">
							<div class="col-8 view-users">
								<p class="title-db">Quản trị viên</p>
								<hr>
								<p><span>Họ và tên: </span>Nguyễn Tuấn Cảnh</p>
								<p><span>Điện thoại: </span>0375577127</p>
								<p><span>Email: </span>canh123@gmail.com</p>
							</div>
							<div class="col-4 avt-users">
								<img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/user/avt-Canh.jpg" alt="">
							</div>
						</div>
					</div>
					<!--End-->
					<div class="col none-mp card-users db-1">
						<div class="row none-mp">
							<div class="col-8 view-users">
								<p class="title-db">Quản trị viên</p>
								<hr>
								<p><span>Họ và tên: </span>Trần Ninh Hiếu</p>
								<p><span>Điện thoại: </span>0375577127</p>
								<p><span>Email: </span>hieu123@gmail.com</p>
							</div>
							<div class="col-4 avt-users">
								<img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/user/avt-hieu.jpg" alt="">
							</div>
						</div>
					</div>
				</div>
