...
<body>
    ...
    <div class="container" style="margin-top: 56px;">
        ...
        <div class="detail">
            <div class="row fix">
                <div class="col-8">
                    <div class="row-border second">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb" style="border-radius: 0rem;">
                                <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}">Trang chủ</a></li>
                                <li class="breadcrumb-item"><a href="tag-all">Thể loại</a></li>
                                <li class="breadcrumb-item active" aria-current="page"><c:out value="${comics.title}"/></li>
                            </ol>
                        </nav>
    
                        <div class="row fix pd-bt">
                            <div class="col-5 detail-comic">
                                <img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}${comics.thumbnail}" alt="...">
                                <div class="sub-comic">
                                    <p class="detail-content"><img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/icon/author-black.svg" alt="">Tác giả: <span><c:out value="${comics.author}"/></span></p>
                                    ...
                                    <p class="detail-content"><img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/icon/sync-black.svg" alt="">Cập nhật: <span>${updateTime}</span></p>
                                </div>
                            </div>
                            <div class="col-7 detail-comic-second">
                                <p class="title-comic"><c:out value="${comics.title}"/></p>
                                <hr>
                                <p class="more-comic-info">
                                    <br>
                                    <c:out value="${comics.description}"/>
                                </p>
                                <hr>
                                <div class="container-btn">
                                    <a class="btn-list-chapter" href=""><img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/icon/list-white.svg" alt="">Danh sách
                                        chương</a>
                                    <a id="follow" class="btn-follow-chapter" ><img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/icon/heart-white.svg" alt="">
                                        <input  type="button" value="Theo dõi truyện" onclick="btnfollow()" id="myBtn"></a>
                                </div>
                                <div class="container-btn">
                                    <a class="btn-like-chapter" >
                                        <img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/icon/like-white.svg" alt="">
                                        <input type="button" value="Thích" onclick="btnlike()" id="BtnLike" style="padding:0"><span> 233</span></a>
                                </div>
                    ...
                    <div class="row fix row-border second">
                        <div class="col col-chapter">
                            <div>
                                <p class="list-chapter"><img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/icon/list-blue.svg" alt="">DANH SÁCH CHƯƠNG</p>
                                <div class="row lst">
                                    <div class="col-6">Số Chương</div>
                                ...
                                <!--20->10-->
                                        ...
                                        <c:forEach items="${firstListChapter}" var="FirstListChapters">

                                                <div class="row lst lst-sc">
                                                    <div class="col-6"><a href="reading?id=${comics.id}&chapter=${FirstListChapters.chapter}">Chapter ${FirstListChapters.chapter}</a></div>
                                                    <div class="col-3">${FirstListChapters.created}</div>
                                ...
                                <!--All Chapter-->
                                <div id="all-chapter" class="collapse">

                                        <c:forEach items="${lastListChapter}" var="LastListChapters">

                                                <div class="row lst lst-sc">
                                                    <div class="col-6"><a href="reading?id=${comics.id}&chapter=${LastListChapters.chapter}">Chapter ${LastListChapters.chapter}</a></div>
                                                    <div class="col-3">${LastListChapters.created}</div>
                                ...
                                <div class="all-chapter-btn">
                                    <a role="button" data-toggle="collapse" data-target="#all-chapter">Xem tất cả</a>
                                </div>
                                                ...
                                                <c:forEach items="${Comment}" var="comments">
                                                    <div class="row fix-comment">
                                                        <div class="col-1 avt-comment">
                                                            <span><img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}/assets/img/user/avata-mac-dinh.jpg" alt=""></span>
                                                        </div>
                                                        <div class="col-11 cmt">
                                        ...
                                        <div class="page-al">
                                            <nav aria-label="Page navigation">
                                                <ul class="pagination">
                                                    ...
                                                    <li class="page-item"><a class="page-link" href="detail?id=${comics.id}&page=1">1</a></li>
                                                    <li class="page-item"><a class="page-link" href="detail?id=${comics.id}&page=2">2</a></li>
                                                    <li class="page-item"><a class="page-link" href="detail?id=${comics.id}&page=3">3</a></li>
                                                    <li class="page-item">
