            ...
            <div class="row none-mp">
                <div class="col-3 none-mp">
                    <div class="account-menu box">
                        ...
                        <ul class="account-list">
                            ...
                            <a href="follow">
                                <li class="account-list-item active">Truyện đang theo dõi</li>
                            </a>
                ...
                <div class="col-9 account-infor none-mp">
                    ...
                    <div class=" follow-box">
                        <p class="changepw-title title">Truyện đang theo dõi</p>
                                ...
                                <div>
                                    ...
                                    <div class="row chapter-history none-mp">
                                        <div class="col none-mp">
                                            <a href="#"><img src="/assets/img/icon/close-gray.svg" alt="">Bỏ theo dõi</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
