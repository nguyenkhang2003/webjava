...
<body>
    ...
    <div class="container" style="margin-top: 56px;">
            ...
            <div class="row fix">
                <div class="col row-border second none-padding-top">
                    ...
                    <!--Sub-->
                    <div class="row sub-reading none-mp">
                        <div class="col none-mp">
                            ...
                            <div class="chapter-controller" id="controller">
                                ...
                                <select class="select" onchange="location = this.value;">
                                    ...
                                    <c:forEach items="${getChapterCount}" var="GetChapterCount">
                                        <c:choose>
                                        <c:when test="${GetChapterCount == chapter}">
                                            <option selected="selected" value="reading?id=${comics.id}&chapter=${GetChapterCount}" ">                                            
                                                Chapter ${GetChapterCount}</option>
                                        </c:when>
                                        <c:otherwise>
                                                <option value="reading?id=${comics.id}&chapter=${GetChapterCount}" ">                                            
                                                Chapter ${GetChapterCount}</option>
    ...
    <!--Content Chapter-->
    <div class="container content-chapter-al">
        <div class="chapter-content-section">
            <c:forEach items="${chapters}" var="chapter">
            <div>
                <img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}${chapter.chapterContentURL}" alt="">
            </div>  
            </c:forEach>
                                ...
                                <li class="page-item">
                                    <a class="page-link" href="#" aria-label="Previous">
                                        <span aria-hidden="true">&laquo;</span>
                                                    ...
                                                    <li class="page-item"><a class="page-link" href="reading?id=${comics.id}&chapter=${chapter}&page=1">1</a></li>
                                                    <li class="page-item"><a class="page-link" href="reading?id=${comics.id}&chapter=${chapter}&page=2">2</a></li>
                                                    <li class="page-item"><a class="page-link" href="reading?id=${comics.id}&chapter=${chapter}&page=3">3</a></li>
                                <li class="page-item">
