        ...
        <div>
            <div class="row fix">
                <div class="col-8 row-border second">
                    ...
                    <!--Hot-->
                    <div class="hot-tag">
                        <div class="row fix bg-hot-tag xuyen-khong"></div>
                        <div class="row fix">
                            <div class="col-4 img-hot-tag none-mp">
                                <img src="${pageContext.request.scheme}://${pageContext.request.serverName}:${pageContext.request.serverPort}/${pageContext.request.contextPath}${comic.get(1).thumbnail}" alt="">
                            </div>
                            <div class="col-8 content-hot-tag">
                                <p title="${comics.get(0).title}" class="title-hot-tag"><a href="detail?id=${comics.get(0).id}">
                                        <c:out value="${comics.get(0).title}">
                                            
                                        </c:out>
                                    </a></p>
                                <p class="detail-content-hot-tag mb-ds"><img src="${pageContext.request.contextPath}/assets/img/icon/author-white.svg" alt="">Tác giả: <span>${comics.get(0).author}</span></p>
                                <p class="detail-content-hot-tag"><img src="${pageContext.request.contextPath}/assets/img/icon/eye-white.svg" alt="">Lượt xem:
                                    <span>${comics.get(0).views}</span>
                                </p>
                                <p class="detail-content-hot-tag mb-ds"><img src="${pageContext.request.contextPath}/assets/img/icon/stream-white.svg" alt="">Tình trạng: <span>${comics.get(0).status}</span></p>
                                <p class="detail-content-hot-tag last mb-ds"><img src="${pageContext.request.contextPath}/assets/img/icon/sync-white.svg" alt="">Cập nhật: <span>18:56
                                        19/05/2021</span></p>
                    ...
                    <div class="page-al">
                        <nav aria-label="Page navigation" >
                            <ul class="pagination">
                                ...
                                <li class="page-item"><a class="page-link" href="tag?tag=${tagDescriptions.tag}&page=1">1</a></li>
                                <li class="page-item"><a class="page-link" href="tag?tag=${tagDescriptions.tag}&page=2">2</a></li>
                                <li class="page-item"><a class="page-link" href="tag?tag=${tagDescriptions.tag}&page=3">3</a></li>
